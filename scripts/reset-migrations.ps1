p# Reset Migrations - Cash Flow System
# Script para resetar e recriar migracoes do zero

$ErrorActionPreference = "Stop"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Reset de Migracoes Prisma" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "AVISO: Este script vai DROPAR e RECRIAR os bancos de dados!" -ForegroundColor Yellow
Write-Host ""
