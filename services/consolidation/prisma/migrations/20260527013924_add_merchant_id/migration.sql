...
-- CreateIndex
CREATE INDEX "daily_balances_merchant_id_idx" ON "daily_balances"("merchant_id");

-- CreateIndex
CREATE INDEX "daily_balances_consolidated_at_idx" ON "daily_balances"("consolidated_at");

-- CreateIndex
CREATE UNIQUE INDEX "daily_balances_merchant_id_date_key" ON "daily_balances"("merchant_id", "date");
